...
import 'package:food_eye_fyp/ui/customer/customer_order_page/widgets/editquantity_popup.dart';
...
class CustOrderPage extends StatelessWidget {
  const CustOrderPage({super.key});

  @override
  Widget build(BuildContext context) {
    final state = Provider.of<CustOrderPageState>(context);
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          FutureBuilder<List<CustOrderResponse>>(
                        ...
                        builder: (context, isDescending, _) {
                          return InkWell(
                            ...
                            child: Slidable(
                                    ...
                                    onPressed: (context) {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          ...
                                          content: Text(
                                              "Order for '${item.productName}' deleted successfully!"),
                                        ),
                                      );
                                    },
                                  ),
                              ...
                              child: CustomOrderCard(order: item),
                            ),
                          );
                        },
                      );
